...
# ============================================================
convert_single_video = 1              # 1 = single video, 0 = full playlist
use_spacy_for_sentence_splitting = 1  # 1 = SpaCy (better), 0 = regex
use_openai_api_for_transcription = 0  # 1 = OpenAI API, 0 = local Whisper (recommended)
openai_api_key = 'REPLACE_WITH_YOUR_API_KEY'
max_simultaneous_youtube_downloads = 4
disable_cuda_override = 0             # Set to 1 to force CPU even if CUDA is available
...
max_workers_transcribe = psutil.cpu_count(logical=False)
